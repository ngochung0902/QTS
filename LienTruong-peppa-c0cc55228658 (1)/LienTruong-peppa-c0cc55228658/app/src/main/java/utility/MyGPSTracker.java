...
public class MyGPSTracker extends Service implements LocationListener {
	...
	//private static final long MIN_TIME_BW_UPDATES = 250 * 60 * 1; // 1 minute
	...
	/**
	 * Function to update Location at some interval
	 * 
	 * @return boolean
	 * */
	public Location LocationUpdateAtRegularInterval() {
			...
			if (isNetworkEnabled) {
				...
				if (locationManager != null) {
					...
					if (location != null) {
						latitude = location.getLatitude();
						longitude = location.getLongitude();
						System.out.println("latitude: netwrork"+latitude);
						System.out.println("longitude:netwrork"+longitude);
					}
				}
	...
	public void showSettingsAlert() {
		...
		String str_msg=getResources().getString(R.string.app_name)+" needs access to your location.Please turn on location access.";
		alertDialog.setMessage(str_msg);
		/*
		 * alertDialog
