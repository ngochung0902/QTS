...
public class AvatarRelativeBehavior extends CoordinatorLayout.Behavior<RelativeLayout> {
    ...
    public AvatarRelativeBehavior(Context context, AttributeSet attrs) {
        mContext = context;
        init();
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.text_width);
    }
    ...
    private void maybeInitProperties(RelativeLayout child, View dependency) {
        if (mStartYPosition == 0)
            mStartYPosition = (int) (dependency.getY())+mContext.getResources().getDimensionPixelOffset(R.dimen.coordinate_relative_margintop);
